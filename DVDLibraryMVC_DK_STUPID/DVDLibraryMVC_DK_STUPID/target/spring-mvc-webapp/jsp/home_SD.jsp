		...
		<div class="navbar">
			<ul class="nav nav-tabs">
				...
				<li role="presentation"><a
					href="${pageContext.request.contextPath}/displayDvdLibrary">Dvd
						Controller</a></li>
			...
			<div class="col-md-6">
				...
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" class="form-control" id="add-user-note"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							<label for="edit-release-date" class="col-md-4 control-label">Rlease Date</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="edit-mpaa-rating" class="col-md-4 control-label">MPAA
								Rating</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" id="edit-director-name"
									placeholder="Director" />
							</div>
						</div>
						...
						<div class="form-group">
							<label for="edit-user-note" class="col-md-4 control-label">User
								Rating</label>
							<div class="col-md-8">
								<input type="text" class="form-control" id="edit-user-note"
									placeholder="User Note" />
							</div>
						</div>
