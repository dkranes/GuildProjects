...
//    }
    ...
    public String addDvd(@Valid Dvd dvd, BindingResult result, HttpServletRequest req) throws IOException, ParseException {
        ...
        //Date releaseDate = new Date(df.parse(stringDate).getTime());
        ...
        //newDvd.setStringDate(stringDate);
        dao.addDVD(newDvd);
        //dao.writeToDVDLibrary();
...
//        Date tempDate = Date.from(instant);
//        
//        Date finalDate = DateUtils.truncate(releaseDate, Calendar.DATE);
//        
//        return finalDate;
//    }
