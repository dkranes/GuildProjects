...
function dateFormatter3(releaseDate) {
...
function fillDvdTable(dvdList, status) {
    ...
    {
        var finalDate = dateFormatter2(dvd.releaseDate);
        ...
        cTable.append($('<tr>')
                .append($('<td>').append($('<a>')
                        ...
                        .text(dvd.title)))
                .append($('<td>').text(dateFormatter2(dvd.releaseDate)))
                .append($('<td>').append($('<a>')
                        .attr({
                            'data-dvd-id': dvd.dvdId,
                            'data-toggle': 'modal',
...
$(document).ready(function () {
    ...
    $('#detailsModal').on('show.bs.modal', function (event) {
        ...
        $.ajax({
            ...
            modal.find('#dvd-release-date').text(dateFormatter2(dvd.releaseDate));
    ...
    $('#editModal').on('show.bs.modal', function (event) {
        ...
        $.ajax({
            ...
            modal.find('#edit-release-date').val(dateFormatter3(dvd.releaseDate));
