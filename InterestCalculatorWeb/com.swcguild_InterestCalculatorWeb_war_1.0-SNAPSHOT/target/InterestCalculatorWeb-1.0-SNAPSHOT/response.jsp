...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        You calculated interest for an initial balance of: $${originalBalance}<br />
        Duration: ${years} years<br/>
        Interest was compounded: ${periods} times per year<br/>
        Interest earned: $${interestEarned}<br/>
        Ending balance: $${newBalance}
